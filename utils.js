...
export class Elem {
    ...
    static {
        ...
        s.innerHTML = `.fadeOut{-webkit-animation:fade-out 1s ease-out both;animation:fade-out 1s ease-out both}
        /* ----------------------------------------------
...
@-webkit-keyframes fadeOut{0%{opacity:1}100%{opacity:0}}@keyframes fade-out{0%{opacity:1}100%{opacity:0}}
.fadeIn{-webkit-animation:fadeIn 1.2s cubic-bezier(.39,.575,.565,1.000) both;animation:fade-in 1.2s cubic-bezier(.39,.575,.565,1.000) both}
/* ----------------------------------------------
...
@-webkit-keyframes fadeIn{0%{opacity:0}100%{opacity:1}}@keyframes fade-in{0%{opacity:0}100%{opacity:1}}`
